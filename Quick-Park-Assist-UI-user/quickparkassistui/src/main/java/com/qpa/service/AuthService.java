...
public class AuthService {
    ...
    /**
     * ✅ Checks if the user is authenticated by calling the backend authentication check API.
     *
    ...
    /**
     * ✅ Registers a new user by sending the registration details to the backend API.
     *
    ...
    public ResponseDTO<Void> login(AuthUser authUser, HttpServletResponse response, HttpServletRequest request) {
        ResponseEntity<ResponseDTO<Void>> backendResponse = restTemplateService.login(authUser, request, response);
